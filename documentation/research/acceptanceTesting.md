...
For website development testing, postman will be used regularly to ensure that data flows through corrects. However, in regard to the testing of the XR component, the team will only be able to test the Hololens 2 on campus since UTS has limited amount. And as a result, an emulator will be used when the Hololens will not be available for testing.  

Regarding the time-frame, the testing managers will oversee all testing is appropriately done. The bottom level testing will be completed before reaching the higher levels.  
